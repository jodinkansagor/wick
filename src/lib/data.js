export const data = {
  ...
  coaching1: "I am motivated by a strong desire to help my clients move through transitions in life feeling confident and secure. While my work touches many aspects of life, I specialize in: Sex and Sexuality, Gender Identity, Ethical Non-Monogamy, Relationship Restructuring, Intimacy and Security, Aging, Ability and Chronic Illness. As a disabled person, I am uniquely poised to help clients who are adjusting to new disabilities, getting back to work after dealing with a disability or health challenges, or navigating intimate relationships (including the relationship with one’s own self) while newly disabled.",
